...
public class Expt
{
    ...
    throws IOException
  {
    ...
    //    Game game1 = new Game(LocalDate.parse(date1.subSequence(0,date1.length())), school1, school2);
    //    Game game2 = new Game(LocalDate.parse("2014-11-20".subSequence(0, 10)), school2, school1);
    //    Game game3 = new Game(LocalDate.parse("2014-11-21".subSequence(0, 10)), school3, school2);
    //    Game game4 = new Game(LocalDate.parse("2014-11-22".subSequence(0, 10)), school2, school3);
    //    Game game5 = new Game(LocalDate.parse("2014-11-23".subSequence(0, 10)), school1, school3);
